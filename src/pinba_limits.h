...
#define PINBA_TAG_VALUE_SIZE 513
#define PINBA_DICTIONARY_ENTRY_SIZE 513 /* must be equal to the greater of the two above */

#define PINBA_ERR_BUFFER 2048

#define PINBA_UDP_BUFFER_SIZE 262144
